...
public class LevelOrderPrinter {
     ...
     * 添加一个元素节点
     */
    private Node addNode(List<Node> nodes, TreeNode btNode) {
        Node node = null;
        if (btNode != null) {
        ...
        while (true) {
            ...
            for (Node node : preRowNodes) {
                if (node == null) {
                    ...
                    Node left = addNode(rowNodes, node.btNode.left);
                    if (left != null) {
                        node.left = left;
                        left.parent = node;
                        notNull = true;
                    ...
                    Node right = addNode(rowNodes, node.btNode.right);
                    if (right != null) {
                        node.right = right;
                        right.parent = node;
                        notNull = true;
    ...
    private static class Node {
        ...
        public Node(TreeNode btNode) {
            init(String.valueOf(btNode.val));
